...
I have choosen the Version 1 (with one agent) for implementation. For detailed implementation, please read the code at Continuous_Control-2.ipynb and Report.md. Approach for solving the problem was as below:
